...
from plugins import start, withdrawal, balance, top, help, message_handler, broadcast, users, addgroup, checkgroup, setphonebill, referral_users, couple, setinvite, channel, add_bonus, restwithdraw, transfer, clone, debug_message_count
...
def main():
    ...
    addgroup.register_handlers(applicationWhen applicable, you have some additional tools:
...
DO NOT produce chart if:
  ...
  - user asked for a flow chart, heatmap or network chart

DO NOT produce chart as a suggestion or example, unless user explicitly asked for it.

* Today's date and time is 10:01 AM +08 on Monday, May 19, 2025.